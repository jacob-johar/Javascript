...
window.onload = function(){
    var imageContainer = document.querySelector("#imgFile");
    var imgPage="";
    images.forEach(image => {
                   imgPage+="<figure>";
                   imgPage+='<img alt="'+image.alt+'" src="'+image.url+'">';
                   imgPage+="<figcaption>"+image.caption+"</figcaption>";
                   imgPage+="</figure>";
                   });
    imageContainer.innerHTML+=imgPage;
}
